  ...
  <ul class="navigation">
    ...
    <li class="parent" id="clients">
      ...
      <ul class="subnavigation">
        <li><a class="link" href="../Currency_Converter/index.html"
            onclick="openPopup('../Currency_Converter/index.html'); return false;">Currency Converter</a></li>
        <li><a class="link" href="../FAQs/index.php" target="_blank">FAQs</a></li>
        <li><a class="link" href="../Ratings/RatingsOut.php" target="_blank">Ratings</a></li>
      </ul>
    </li>
    <li class="parent" id="services">
      <a class="link" href="#"><i class="fas fa-minus"></i> Services <i class="fas fa-plus"></i></a>
      <ul class="subnavigation">
        <li><a class="link" href="../tourism/index.php">Tourism</a></li>
        <li><a class="link" href="../tourism/festivals.php">Festivals</a></li>
        <li><a class="link" href="../hotels/index.php">hotels</a></li>
        <li><a class="link" href="../rent/index.php" target="_blank">Car Rental</a></li>
        <li><a class="link" href="../weatherapp/index.php"
            onclick="openPopup('../weatherapp/index.php'); return false;">Weather app</a></li>
      </ul>
    </li>
