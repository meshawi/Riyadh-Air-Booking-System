...
if (isset($_SESSION['flightID'], $_SESSION['passengers'], $_SESSION['totalPrice'])) {
...
<body>
    ...
    <div class="container">
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
              ...
              MDowMIXeN6gAAAAASUVORK5CYII="></image>
                    ...
                    <p class="name" id="cardholderName">BRUCE WAYNE</p>
                </div>
        ...
        <form action="../incloudes/payment_process.php" method="post">
            <input type="hidden" name="flightID" value="<?php echo $flightID; ?>">
            <!-- Mock payment details -->
            <input type="text" placeholder="Card Number:" name="cardNumber" id="cardNumberInput"
                oninput="updateCardNumber()">
            <input type="text" placeholder="Cardholder's Name:" name="cardholderName" id="cardholderNameInput"
                oninput="updateCardholderName()">
            <input type="text" placeholder="Card Expiry:" name="cardExpiry" id="cardExpiryInput"
                oninput="updateCardExpiry()">
            <input type="text" placeholder="CVV:" name="cardCVV" id="cardCVVInput" oninput="updateCardCVV()">
            <br>
